...
new worldMapTile(true, false, false, new teleportEntry('CorneriaCastle', 'CorneriaCastle1F', 12, 35)),
new worldMapTile(true, false, false, new teleportEntry('CorneriaCastle', 'CorneriaCastle1F', 12, 35)),
...
new dungeonMapTile(true, new teleportEntry('IceCave4', 'IceCaveB3', 0x33, 0xb)),
new dungeonMapTile(true),
// Row 4
new dungeonMapTile(),
new dungeonMapTile(true),
...
Game.load = function () {
    return [
		...
		Loader.loadMapData('Volcano1', 'Assets/Gurgu%20Volcano%20B1%20Map.ffh'),
		Loader.loadMapData('Volcano2', 'Assets/Gurgu%20Volcano%20B2%20Map.ffh'),
		Loader.loadMapData('Volcano3', 'Assets/Gurgu%20Volcano%20B3%20Map.ffh'),
		Loader.loadMapData('Volcano4', 'Assets/Gurgu%20Volcano%20B4%20Map.ffh'),
		Loader.loadMapData('Volcano5', 'Assets/Gurgu%20Volcano%20B5%20Map.ffh'),
