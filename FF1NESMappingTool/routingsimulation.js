...
function WeaponInfo(index, name, hit, attack, crit, spell)
{
	this.index = index;
	this.name = name;
	this.hit = hit;
...
function ArmorInfo(index, name, evade, absorb, resistances, spell, slot)
{
	this.index = index;
	this.name = name;
	this.evade = evade;
...
const weapons = {
	'WoodenNunchucks': new WeaponInfo('WoodenNunchucks', 'Wooden Nunchucks', 0x00, 0x0c, 0x01, 0x00),
	'SmallKnife': new WeaponInfo('SmallKnife', 'Small Knife', 0x0a, 0x05, 0x02, 0x00),
	'WoodenStaff': new WeaponInfo('WoodenStaff', 'Wooden Staff', 0x00, 0x06, 0x03, 0x00),
	'Rapier': new WeaponInfo('Rapier', 'Rapier', 0x05, 0x09, 0x04, 0x00),
	'IronHammer': new WeaponInfo('IronHammer', 'Iron Hammer', 0x00, 0x09, 0x05, 0x00),
	'ShortSword': new WeaponInfo('ShortSword', 'Short Sword', 0x0a, 0x0f, 0x06, 0x00),
	'HandAxe': new WeaponInfo('HandAxe', 'Hand Axe', 0x05, 0x10, 0x07, 0x00),
	'Scimtar': new WeaponInfo('Scimtar', 'Scimtar', 0x0a, 0x0a, 0x08, 0x00),
	'IronNunchucks': new WeaponInfo('IronNunchucks', 'Iron Nunchucks', 0x00, 0x10, 0x09, 0x00),
	'LargeKnife': new WeaponInfo('LargeKnife', 'Large Knife', 0x0a, 0x07, 0x0a, 0x00),
	'IronStaff': new WeaponInfo('IronStaff', 'Iron Staff', 0x00, 0x0e, 0x0b, 0x00),
	'Sabre': new WeaponInfo('Sabre', 'Sabre', 0x05, 0x0d, 0x0c, 0x00),
	'LongSword': new WeaponInfo('LongSword', 'Long Sword', 0x0a, 0x14, 0x0d, 0x00),
	'GreatAxe': new WeaponInfo('GreatAxe', 'Great Axe', 0x05, 0x16, 0x0e, 0x00),
	'Falchon': new WeaponInfo('Falchon', 'Falchon', 0x0a, 0x0f, 0x0f, 0x00),
	'SilverKnife': new WeaponInfo('SilverKnife', 'Silver Knife', 0x0f, 0x0a, 0x10, 0x00),
	'SilverSword': new WeaponInfo('SilverSword', 'Silver Sword', 0x0f, 0x17, 0x11, 0x00),
	'SilverHammer': new WeaponInfo('SilverHammer', 'Silver Hammer', 0x05, 0x0c, 0x12, 0x00),
	'SilverAxe': new WeaponInfo('SilverAxe', 'Silver Axe', 0x0a, 0x19, 0x13, 0x00),
	'FlameSword': new WeaponInfo('FlameSword', 'Flame Sword', 0x14, 0x1a, 0x14, 0x00),
	'IceSword': new WeaponInfo('IceSword', 'Ice Sword', 0x19, 0x1d, 0x15, 0x00),
	'DragonSword': new WeaponInfo('DragonSword', 'Dragon Sword', 0x0f, 0x13, 0x16, 0x00),
	'GiantSword': new WeaponInfo('GiantSword', 'Giant Sword', 0x14, 0x15, 0x17, 0x00),
	'SunSword': new WeaponInfo('SunSword', 'Sun Sword', 0x1e, 0x20, 0x18, 0x00),
	'CoralSword': new WeaponInfo('CoralSword', 'Coral Sword', 0x0f, 0x13, 0x19, 0x00),
	'WereSword': new WeaponInfo('WereSword', 'Were Sword', 0x0f, 0x12, 0x1a, 0x00),
	'RuneSword': new WeaponInfo('RuneSword', 'Rune Sword', 0x0f, 0x12, 0x1b, 0x00),
	'PowerStaff': new WeaponInfo('PowerStaff', 'Power Staff', 0x00, 0x0c, 0x1c, 0x00),
	'LightAxe': new WeaponInfo('LightAxe', 'Light Axe', 0x0f, 0x1c, 0x1d, 0x12),
	'HealStaff': new WeaponInfo('HealStaff', 'Heal Staff', 0x00, 0x06, 0x1e, 0x14),
	'MageStaff ': new WeaponInfo('MageStaff ', 'Mage Staff ', 0x0a, 0x0c, 0x1f, 0x15),
	'Defense': new WeaponInfo('Defense', 'Defense', 0x23, 0x1e, 0x20, 0x04),
	'WizardStaff': new WeaponInfo('WizardStaff', 'Wizard Staff', 0x0f, 0x0f, 0x21, 0x1f),
	'Vorpal': new WeaponInfo('Vorpal', 'Vorpal', 0x19, 0x18, 0x22, 0x00),
	'CatClaw': new WeaponInfo('CatClaw', 'CatClaw', 0x23, 0x16, 0x23, 0x00),
...
const armor = {
	'Cloth': new ArmorInfo('Cloth', 'Cloth', 0x02, 0x01, 0x00, 0x00, 0x00),
	'WoodenArmor': new ArmorInfo('WoodenArmor', 'Wooden Armor', 0x08, 0x04, 0x00, 0x00, 0x00),
	'ChainArmor': new ArmorInfo('ChainArmor', 'Chain Armor', 0x0f, 0x0f, 0x00, 0x00, 0x00),
	'IronArmor': new ArmorInfo('IronArmor', 'Iron Armor', 0x17, 0x18, 0x00, 0x00, 0x00),
	'SteelArmor': new ArmorInfo('SteelArmor', 'Steel Armor', 0x21, 0x22, 0x00, 0x00, 0x00),
	'SilverArmor': new ArmorInfo('SilverArmor', 'Silver Armor', 0x08, 0x12, 0x00, 0x00, 0x00),
	'FlameArmor': new ArmorInfo('FlameArmor', 'Flame Armor', 0x0a, 0x22, 0x20, 0x00, 0x00),
	'IceArmor': new ArmorInfo('IceArmor', 'Ice Armor', 0x0a, 0x22, 0x10, 0x00, 0x00),
	'OpalArmor': new ArmorInfo('OpalArmor', 'Opal Armor', 0x0a, 0x2a, 0x40, 0x00, 0x00),
	'DragonArmor': new ArmorInfo('DragonArmor', 'Dragon Armor', 0x0a, 0x2a, 0x70, 0x00, 0x00),
	'CopperBracelet': new ArmorInfo('CopperBracelet', 'Copper Bracelet', 0x01, 0x04, 0x00, 0x00, 0x00),
	'SilverBracelet': new ArmorInfo('SilverBracelet', 'Silver Bracelet', 0x01, 0x0f, 0x00, 0x00, 0x00),
	'GoldBracelet': new ArmorInfo('GoldBracelet', 'Gold Bracelet', 0x01, 0x18, 0x00, 0x00, 0x00),
	'OpalBracelet': new ArmorInfo('OpalBracelet', 'Opal Bracelet', 0x01, 0x22, 0x00, 0x00, 0x00),
	'WhiteShirt': new ArmorInfo('WhiteShirt', 'White Shirt', 0x02, 0x18, 0x18, 0x2c, 0x00),
	'BlackShirt': new ArmorInfo('BlackShirt', 'Black Shirt', 0x02, 0x18, 0x24, 0x20, 0x00),
	'WoodenShield': new ArmorInfo('WoodenShield', 'Wooden Shield', 0x00, 0x02, 0x00, 0x00, 0x01),
	'IronShield': new ArmorInfo('IronShield', 'Iron Shield', 0x00, 0x04, 0x00, 0x00, 0x01),
	'SilverShield': new ArmorInfo('SilverShield', 'Silver Shield', 0x00, 0x08, 0x00, 0x00, 0x01),
	'FlameShield': new ArmorInfo('FlameShield', 'Flame Shield', 0x00, 0x0c, 0x20, 0x00, 0x01),
	'IceShield': new ArmorInfo('IceShield', 'Ice Shield', 0x00, 0x0c, 0x10, 0x00, 0x01),
	'OpalShield': new ArmorInfo('OpalShield', 'Opal Shield', 0x00, 0x10, 0x40, 0x00, 0x01),
	'AegisShield': new ArmorInfo('AegisShield', 'Aegis Shield', 0x00, 0x10, 0x02, 0x00, 0x01),
	'Buckler': new ArmorInfo('Buckler', 'Buckler', 0x00, 0x02, 0x00, 0x00, 0x01),
	'ProCape': new ArmorInfo('ProCape', 'ProCape', 0x02, 0x08, 0x00, 0x00, 0x01),
	'Cap': new ArmorInfo('Cap', 'Cap', 0x01, 0x01, 0x00, 0x00, 0x02),
	'WoodenHelmet': new ArmorInfo('WoodenHelmet', 'Wooden Helmet', 0x03, 0x03, 0x00, 0x00, 0x02),
	'IronHelmet': new ArmorInfo('IronHelmet', 'Iron Helmet', 0x05, 0x05, 0x00, 0x00, 0x02),
	'SilverHelmet': new ArmorInfo('SilverHelmet', 'Silver Helmet', 0x03, 0x06, 0x00, 0x00, 0x02),
	'OpalHelmet': new ArmorInfo('OpalHelmet', 'Opal Helmet', 0x03, 0x08, 0x00, 0x00, 0x02),
	'HealHelmet': new ArmorInfo('HealHelmet', 'Heal Helmet', 0x03, 0x06, 0x00, 0x14, 0x02),
	'Ribbon': new ArmorInfo('Ribbon', 'Ribbon', 0x01, 0x01, 0xff, 0x00, 0x02),
	'Gloves': new ArmorInfo('Gloves', 'Gloves', 0x01, 0x01, 0x00, 0x00, 0x03),
	'CopperGauntlet': new ArmorInfo('CopperGauntlet', 'Copper Gauntlet', 0x03, 0x02, 0x00, 0x00, 0x03),
	'IronGauntlet': new ArmorInfo('IronGauntlet', 'Iron Gauntlet', 0x05, 0x04, 0x00, 0x00, 0x03),
	'SilverGauntlet': new ArmorInfo('SilverGauntlet', 'Silver Gauntlet', 0x03, 0x06, 0x00, 0x00, 0x03),
	'ZeusGauntlet': new ArmorInfo('ZeusGauntlet', 'Zeus Gauntlet', 0x03, 0x06, 0x00, 0x17, 0x03),
	'PowerGauntlet': new ArmorInfo('PowerGauntlet', 'Power Gauntlet', 0x03, 0x06, 0x00, 0x37, 0x03),
	'OpalGauntlet': new ArmorInfo('OpalGauntlet', 'Opal Gauntlet', 0x03, 0x08, 0x00, 0x00, 0x03),
	'ProRing': new ArmorInfo('ProRing', 'ProRing', 0x01, 0x08, 0x08, 0x00, 0x03),
};
...
const encounters = {
	...
	0x85: new EncounterInfo(Formation.small, true, 55, new EncounterSlot(enemies.Spider, 0, 0), new EncounterSlot(enemies.Scum, 2, 4)),
	...
	0x3E: new EncounterInfo(Formation.large, true, 4, new EncounterSlot(enemies.Wyvern, 0, 0), new EncounterSlot(enemies.Wyrm, 0, 0), new EncounterSlot(enemies['T Rex'], 1, 1)),
	...
	0x46: new EncounterInfo(Formation.mix, false, 4, new EncounterSlot(enemies.Ghost, 0, 0), new EncounterSlot(enemies.Phantom, 1, 1)),
	...
	0xD6: new EncounterInfo(Formation.mix, true, 75, new EncounterSlot(enemies.WarMech, 0, 0), new EncounterSlot(enemies.Fighter, 1, 2)),
	...
	0x5B: new EncounterInfo(Formation.mix, true, 4, new EncounterSlot(enemies.Sahag, 0, 6), new EncounterSlot(enemies['R.Sahag'], 0, 0), new EncounterSlot(enemies.OddEye, 1, 2)),
	...
	0xDC: new EncounterInfo(Formation.mix, true, 4, new EncounterSlot(enemies.Kyzoku, 0, 0), new EncounterSlot(enemies.Shark, 1, 1)),
	0x5D: new EncounterInfo(Formation.mix, true, 4, new EncounterSlot(enemies.Shark, 1, 2), new EncounterSlot(enemies.Sahag, 0, 2)),
	0xDD: new EncounterInfo(Formation.mix, true, 4, new EncounterSlot(enemies.Shark, 0, 0), new EncounterSlot(enemies.Sahag, 4, 6)),
	...
	0x7E: new EncounterInfo(Formation.small, false, 4, new EncounterSlot(enemies.WzSahag, 0, 0), new EncounterSlot(enemies['R.Sahag'], 0, 0), new EncounterSlot(enemies.Pirate, 9, 9)),
...
function PlayerInfo(name, characterClass, primary = true, classChanged = false, level = 1, exp = 0, hp = characterClass.hp, str = characterClass.str, agi = characterClass.agi, int = characterClass.int, vit = characterClass.vit, luck = characterClass.luck, evade = characterClass.evade, absorb = (characterClass.index == Character.monk ? 1 : 0), hit = characterClass.hit, attack = characterClass.attack, mdef = characterClass.mdef, weaknesses = 0, resistances = 0, weapon = null, armor = null, shield = null, helmet = null, glove = null)
{
	this.name = name;
...
function calculateBounces(turn, formation, delay)
{
	let shortBounce = 0, longBounce = 0, timeTaken = 0, holdDirection = false;
	if ((turn > 0) && (formation == Formation.fiend || formation == Formation.chaos) && (delay == 0 || delay == 4))
...
function runBattle(currentState, encounter, encounterAction, encounterEnemyCounts, fightIteration, redoBattleEndState, redoBattleNextState, rngScores, setDelays)
{
	...
	do 
	{
		...
		else
		{
			...
			for (let i = 0; i < (canDelay ? 256 : 1); i++)
			{
				...
				let bounceResult = calculateBounces(battleState.turn - 1, battleState.formation, i);
				...
				if(battleState.battleComplete && encounter.next?.encounterIndex != null)
				{
					...
					if(battleState.aliveHeroes > encounter.maximumPartyCount)
			...
			if(settings.fightLookAhead && encounter.danger >= settings.fightLookAheadDangerThreshold && !battleComplete && canDelay)
			{
				for(let i = 0; i < settings.fightLookAheadWidth; i++)
				{
					...
					for (let j = 0; j < (canDelay ? 256 : 1); j++)
					{
						...
						let bounceResult = calculateBounces(additionalBattleState.turn - 1, additionalBattleState.formation, j);
		...
		if(encounter.targetTime != null && battleState.startTime + battleState.estimatedTime >= encounter.targetTime)
			battleState.badTurn = true;
		...
		if(setDelays == null && (currentIterationCount > 30 || battleState.turn > 30)) // something has probably gone wrong, abort path.  TODO: add better culling to prevent useless turns from eating time/count
		{
			iterationAbortCount++;
			return battleStartState;
		}
			...
			else if(i < settings.fightCompleteLookAheadWidth) // calculate next turn for top scores that aren't complete
			{
				...
				for (let j = 0; j < (canDelay ? 256 : 1); j++)
				{
					...
					if(additionalBattleState.battleComplete && encounter.next?.encounterIndex != null)
					{
						nextEncounterState = encounterEnemyCounts[additionalBattleState.randomNumberIndex];
						additionalBattleState.score -= settings.enemyCountScoreFactor * ((nextEncounterState.startingEnemies + nextEncounterState.encounterState / 4) / (nextEncounterState.minimumEnemies + 1) - 1) * nextDangerRatio;
						if(additionalBattleState.aliveHeroes > encounter.maximumPartyCount)
	...
	battleState.encounterSummary = {hp: battleStartState.battleCharacters[0x80].currentHp, hp2: battleState.battleCharacters[0x80].currentHp, encounter: encounter, formation: battleState.formation, characters: battleStartState.battleCharacters, delay: delayCommands, score: scoreStates, dealt: damageDealtStates, taken: damageTakenStates, time: estimatedTimeStates, enemyActions: enemyActions, totalTime: estimatedTimeTotalStates, startIndex: battleStartState.index + 1, preRNG: currentState.randomNumberIndex, startRNG: battleStartState.randomNumberIndex, endingRNG: battleState.randomNumberIndex, endingScores: bestCompletedScores, encounterState: battleStartState.encounterState};
	return battleState;
}
...
RouteAction.prototype.toString  = function RouteActionToString()
{
	...
	switch(this.action)
	{
		...
		case Action.EquipWeapon:
			result = 'EquipWeapon ' + this.weapon.index + ' ' + this.characterSlot;
			break;
		case Action.UnequipWeapon:
			result = 'UnequipWeapon ' + this.characterSlot;
			break;
		case Action.EquipArmor:
			result = 'EquipArmor ' + this.armor.index + ' ' + this.characterSlot;
			break;
...
var route = [
new RouteAction('CreateCharacter AAAA whitemage 128'),
new RouteAction('CreateCharacter BBBB redmage 129'),
new RouteAction('CreateCharacter CCCC fighter 130 Primary'),
new RouteAction('CreateCharacter DDDD blackmage 131'),
...
new RouteAction('Encounter 7 1 7'),
new RouteAction('EquipWeapon ShortSword 128'),
new RouteAction('Encounter 126 5 26'),
new RouteAction('TimeTarget 999999'),
new RouteAction('Heal -1 128'),
new RouteAction('Encounter 92-2'),
new RouteAction('Encounter 93'),
new RouteAction('Heal -1 128'),
new RouteAction('Encounter 7-2'),
new RouteAction('Encounter 7-2'),
new RouteAction('Encounter 7-2'),
new RouteAction('Encounter 11 3 10'),
new RouteAction('Encounter 10'),
new RouteAction('Encounter 102'),
new RouteAction('Encounter 5-2'),
new RouteAction('Encounter 102'),
new RouteAction('EquipArmor IronArmor 128'),
new RouteAction('Encounter 28 5 45'),
new RouteAction('TimeTarget 999999'),
new RouteAction('Encounter 5-2'),
new RouteAction('Encounter 16'),
new RouteAction('Encounter 107 3 30'),
new RouteAction('Encounter 1-2'),
new RouteAction('Encounter 107 3 30'),
new RouteAction('Encounter 15'),
new RouteAction('Encounter 13'),
new RouteAction('Heal 30 128'),
new RouteAction('Encounter 125 8 75'),
new RouteAction('TimeTarget 999999'),
new RouteAction('Encounter 12 3 3'),
new RouteAction('Encounter 7-2 3 3'),
new RouteAction('EquipWeapon SilverSword 128'),
new RouteAction('Heal -1 128'),
new RouteAction('Encounter 92-2'),
new RouteAction('Encounter 0'),
new RouteAction('Encounter 11'),
new RouteAction('Encounter 2-2'),
new RouteAction('Encounter 92'),
new RouteAction('Encounter 94 3 30'),
new RouteAction('Encounter 94'),
new RouteAction('EquipArmor IronShield 128'),
new RouteAction('EquipArmor IronHelmet 128'),
new RouteAction('Heal 30 128'),
new RouteAction('Encounter 11'),
new RouteAction('Encounter 92-2'),
new RouteAction('Encounter 12-2'),
new RouteAction('Heal 30 128'),
new RouteAction('Encounter 13-2'),
new RouteAction('Encounter 100'),
new RouteAction('Encounter 20-2'),
new RouteAction('Encounter 100'),
new RouteAction('Encounter 19-2'),
new RouteAction('Encounter 29'),
new RouteAction('Encounter 24'),
new RouteAction('Encounter 124 5 125'),
new RouteAction('TimeTarget 999999'),
new RouteAction('Encounter 28 5 125'),
new RouteAction('Encounter 24'),
new RouteAction('Encounter 24'),
new RouteAction('Encounter 17-2'),
new RouteAction('Encounter 22'),
new RouteAction('Encounter 100'),
new RouteAction('Encounter 17-2'),
new RouteAction('Encounter 21'),
new RouteAction('Heal 30 128'),
new RouteAction('Encounter 19'),
new RouteAction('Heal 30 128'),
new RouteAction('Encounter 25'),
new RouteAction('Heal 120 128'),
new RouteAction('Heal 120 128'),
new RouteAction('Encounter 25'),
new RouteAction('Encounter 12-2'),
new RouteAction('Encounter 19'),
...
new RouteAction('Encounter 17-2'),
new RouteAction('Encounter 19-2'),
new RouteAction('Encounter 99'),
new RouteAction('Encounter 22'),
new RouteAction('Encounter 14'),
new RouteAction('Encounter 27 3 30'),
new RouteAction('Encounter 24'),
new RouteAction('Encounter 122 3 150'),
new RouteAction('TimeTarget 999999'),
new RouteAction('Heal 60 128'),
new RouteAction('Encounter 25'),
new RouteAction('Heal -1 128'),
new RouteAction('Encounter 92-2'),
new RouteAction('Encounter 23'),
new RouteAction('Encounter 23'),
new RouteAction('Encounter 30'),
new RouteAction('EquipArmor SilverHelmet 128'),
new RouteAction('Encounter 27-2'),
new RouteAction('Encounter 27-2'),
new RouteAction('Encounter 32'),
new RouteAction('Encounter 95-2'),
new RouteAction('Encounter 32'),
new RouteAction('Encounter 12'),
new RouteAction('Heal 120 128'),
new RouteAction('Encounter 22-2'),
new RouteAction('Encounter 43-2'),
new RouteAction('Encounter 108'),
new RouteAction('Encounter 108'),
new RouteAction('Encounter 47'),
new RouteAction('Encounter 44'),
new RouteAction('Burn 5 128'),
new RouteAction('Encounter 108'),
new RouteAction('Encounter 108'),
new RouteAction('Encounter 44-2'),
new RouteAction('EquipArmor IceShield 128'),
new RouteAction('Encounter 105 3 299'),
new RouteAction('TimeTarget 999999'),
new RouteAction('Encounter 44'),
new RouteAction('Burn 6 128'),
new RouteAction('Encounter 49 3 50'),
new RouteAction('Encounter 28-2'),
new RouteAction('Encounter 15'),
new RouteAction('Encounter 12'),
new RouteAction('Encounter 32'),
new RouteAction('Encounter 32'),
new RouteAction('Encounter 96-2'),
new RouteAction('Encounter 92'),
new RouteAction('Heal -1 128'),
new RouteAction('Burn 45 128'),
new RouteAction('Encounter 34'),
new RouteAction('Burn 154 128'),
new RouteAction('EquipWeapon IceSword 128'),
new RouteAction('Encounter 40'),
new RouteAction('Burn 75 128'),
new RouteAction('Encounter 38 3 50'),
new RouteAction('Burn 15 128'),
new RouteAction('Encounter 121 5 108'),
new RouteAction('Encounter 37'),
new RouteAction('TimeTarget 999999'),
new RouteAction('Heal -1 128'),
new RouteAction('EquipArmor ProRing 128'),
new RouteAction('Heal 30 128'),
new RouteAction('Heal 30 128'),
new RouteAction('Encounter 71 3 50'),
new RouteAction('Encounter 72'),
new RouteAction('Encounter 114'),
new RouteAction('EquipArmor OpalBracelet 128'),
new RouteAction('Encounter 114'),
new RouteAction('Encounter 73'),
new RouteAction('Encounter 90-2'),
new RouteAction('Encounter 71'),
new RouteAction('Encounter 66-2'),
new RouteAction('Encounter 66-2'),
new RouteAction('Encounter 66'),
new RouteAction('Encounter 72'),
new RouteAction('Encounter 97-2'),
new RouteAction('Encounter 73'),
new RouteAction('Encounter 68-2'),
new RouteAction('Encounter 97-2'),
new RouteAction('Encounter 120 10 100'),
new RouteAction('TimeTarget 999999'),
new RouteAction('Heal 60 128'),
new RouteAction('Heal 60 128'),
new RouteAction('Encounter 63'),
new RouteAction('Encounter 63'),
new RouteAction('Encounter 63'),
new RouteAction('Encounter 35-2'),
new RouteAction('Encounter 79'),
new RouteAction('Encounter 63'),
new RouteAction('Encounter 63'),
new RouteAction('Encounter 79'),
new RouteAction('Encounter 79'),
...
new RouteAction('Heal 60 128'),
new RouteAction('Heal -1 128'),
new RouteAction('Encounter 30-2'),
new RouteAction('Encounter 61'),
new RouteAction('Heal 60 128'),
new RouteAction('TimeTarget 999999'),
new RouteAction('Encounter 50-2'),
new RouteAction('Heal 60 128'),
new RouteAction('Encounter 56-2 1 70'),
new RouteAction('Encounter 113-2'),
new RouteAction('Encounter 103-2'),
new RouteAction('Encounter 109-2'),
new RouteAction('Encounter 74'),
new RouteAction('EquipWeapon SunSword 128'),
new RouteAction('Encounter 59'),
new RouteAction('Encounter 109-2'),
new RouteAction('Encounter 78'),
new RouteAction('Encounter 77'),
new RouteAction('Encounter 84 3 50'),
new RouteAction('Encounter 64'),
new RouteAction('Encounter 85-2 10 1'),
new RouteAction('Encounter 51-2 3 50'),
new RouteAction('Encounter 81'),
new RouteAction('Encounter 82-2'),
new RouteAction('Encounter 65-2'),
new RouteAction('Encounter 36-2 3 75'),
new RouteAction('Encounter 119 4 100 Bane'),
new RouteAction('Encounter 61-2'),
new RouteAction('TimeTarget 999999'),
new RouteAction('Heal -1 128'),
new RouteAction('Heal 60 128'),
new RouteAction('Encounter 48-2 3 50'),
new RouteAction('Encounter 47-2 3 100'),
new RouteAction('Encounter 70 5 50'),
new RouteAction('Encounter 85 3 50'),
new RouteAction('Encounter 46-2 3 50'),
new RouteAction('Encounter 59-2 3 100'),
new RouteAction('Encounter 87 3 100'),
new RouteAction('Encounter 64-2 3 50'),
new RouteAction('Encounter 33-2 3 50'),
new RouteAction('Encounter 115 10 50'),
new RouteAction('Encounter 40-2 3 50'),
new RouteAction('Encounter 38-2 3 10'),
new RouteAction('Encounter 41-2 3 15'),
new RouteAction('Encounter 116 10 110'),
new RouteAction('Encounter 73-2 5 90'),
new RouteAction('Encounter 73-2 4 90'),
new RouteAction('Encounter 117 4 100 Bane'),
new RouteAction('Encounter 84-2 3 10'),
new RouteAction('Encounter 88-2 3 10'),
new RouteAction('Encounter 118 4 1 Bane'),
new RouteAction('Encounter 123 4 1 Bane'),
new RouteAction('TimeTarget 999999'),
];
			...
			case Action.Encounter:
				...
				if(currentAction.encounter.next)
				{
					...
					for(let j = 0; j < 256; j++)
					{
						...
						if(currentAction.encounter.next.minimumEnemyCount == nextEncounterState.startingEnemies)
							targetMinimumEnemiesPossible = true;
					}
					if(targetMinimumEnemiesPossible == true)
						minimumEnemies = currentAction.encounter.next.minimumEnemyCount;
					...
					for(let j = 0; j < fightWidth && !oneRoundFight; j++) // not the most efficient way to do this, should save round 1 results for reuse or something, idk
					{
						...
						else
						{
							...
							for(let k = 0; k < summary.score.length; k++)
							{
								...
								let bounceResult = calculateBounces(k, summary.formation, summary.delay[k]);
